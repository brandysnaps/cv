...
\begin{cvitems}
\item {Onboarding of new SRE team members.}
\item {Migrated from Azure PostgreSQL Single server to Flexible server and performed major version upgrades. - Datam Ltd.}
\item {Migrated legacy applications running on VMs to Azure PaaS-based solutions. - Datam Ltd.}
\item {Automated the generation of reports to be sent to customers, saving hundreds of hours per year. - Datam Ltd.}
\item {Led response to recover more than 250,000 deleted documents, fully restoring functionality to the customer. - Datam Ltd.}
\item {Led many major incident responses, leading to reduced downtime and customer impact. - Datam Ltd.}
\item {Assisting with the design, implementation and testing of high-availability architectures. - Datam Ltd.}
\item {Performed failover testing to build confidence for disaster recovery scenarios. - Datam Ltd.}
\item {Remediation of penetration testing findings. - Datam Ltd.}
\item {Built Terraform modules for the rollout of Azure Virtual Desktop (AVD). - Genesis Energy Ltd.}
\item {Migrated legacy applications running on VMs to PaaS and SaaS solutions. - Genesis Energy Ltd.}
\end{cvitems}
}
%------------------------------------------------

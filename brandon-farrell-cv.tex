...
\name{Brandon}{Farrell}
\mobile{(+64) 21-207-1223}

\email{brandonfarrell3004@gmail.com}
\github{brandysnaps}
\linkedin{brandon-farrell}
%\skype{skypeid}
...
\position{Senior Platform Engineer} % Your expertise/fields

\makecvfooter{\today}{Brandon Farrell~~~·~~~CV}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
